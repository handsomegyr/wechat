...
class Merchant
{
    ...
    {
        $params = array();
        $rst = $this->_request->post($this->_url . 'wxa/get_merchant_category', $params);
    ...
    public function apply($first_catid, $second_catid, $qualification_list, $headimg_mediaid, $nickname, $intro, $org_code, $other_files)
    {
        ...
        $rst = $this->_request->post($this->_url . 'wxa/apply_merchant', $params);
        return $this->_client->rst($rst);
    }
    ...
    {
        $params = array();
        $rst = $this->_request->post($this->_url . 'wxa/get_merchant_audit_info', $params);
        return $this->_client->rst($rst);
    }
    ...
    public function modify($headimg_mediaid, $intro)
    {
        ...
        $params['headimg_mediaid'] = $headimg_mediaid;
        $params['intro'] = $intro;
        $rst = $this->_request->post($this->_url . 'wxa/modify_merchant', $params);
        return $this->_client->rst($rst);
    }
    ...
    {
        $params = array();
        $rst = $this->_request->post($this->_url . 'wxa/get_district', $params);
        return $this->_client->rst($rst);
    }
    ...
    public function searchMapPoi($districtid, $keyword)
    {
        ...
        $rst = $this->_request->post($this->_url . 'wxa/search_map_poi', $params);
        return $this->_client->rst($rst);
    }
    ...
    public function createMapPoi($name, $longitude, $latitude, $province, $city, $district, $address, $category, $telephone, $photo, $license, $introduct, $districtid, $poi_id)
    {
        ...
        $rst = $this->_request->post($this->_url . 'wxa/create_map_poi', $params);
        return $this->_client->rst($rst);
    }
    ...
    public function addStore($map_poi_id, $pic_list, $contract_phone, $hour, $credential, $company_name, $qualification_list, $card_id, $poi_id)
    {
        ...
        $params['poi_id'] = $poi_id;
        $rst = $this->_request->post($this->_url . 'wxa/add_store', $params);
        return $this->_client->rst($rst);
    }
    ...
    public function updateStore($map_poi_id, $pic_list, $contract_phone, $hour, $card_id, $poi_id)
    {
        ...
        $params['card_id'] = $card_id;
        $params['poi_id'] = $poi_id;
        $rst = $this->_request->post($this->_url . 'wxa/update_store', $params);
        return $this->_client->rst($rst);
    }
    ...
    public function getStoreInfo($poi_id)
    {
        $params = array();
        $params['poi_id'] = $poi_id;
        $rst = $this->_request->post($this->_url . 'wxa/get_store_info', $params);
        return $this->_client->rst($rst);
    }
    ...
    public function getStoreList($offset = 0, $limit = 20)
    {
        ...
        $rst = $this->_request->post($this->_url . 'wxa/get_store_list', $params);
        return $this->_client->rst($rst);
    }
    ...
    public function deleteStore($poi_id)
    {
        $params = array();
        $params['poi_id'] = $poi_id;
        $rst = $this->_request->post($this->_url . 'wxa/del_store', $params);
        return $this->_client->rst($rst);
    }
}
