...
class Giftcard
{
    ...
    public function pageAdd(\Weixin\Model\GiftCard\Page $page)
    {
        ...
        $rst = $this->_request->post($this->_url . 'card/giftcard/page/add', $params);
    ...
    public function pageGet($page_id)
    {
        ...
        $rst = $this->_request->post($this->_url . 'card/giftcard/page/get', $params);
        return $this->_client->rst($rst);
    }
    ...
    public function pageUpdate(\Weixin\Model\GiftCard\Page $page)
    {
        $params = array();
        $params['page'] = $page->getParams();
        $rst = $this->_request->post($this->_url . 'card/giftcard/page/update', $params);
        return $this->_client->rst($rst);
    }
    ...
    {
        $params = array();
        $rst = $this->_request->post($this->_url . 'card/giftcard/page/batchget', $params);
        return $this->_client->rst($rst);
    }
    ...
    public function maintainSet($page_id, $maintain = true)
    {
        ...
        $rst = $this->_request->post($this->_url . 'card/giftcard/maintain/set', $params);
        return $this->_client->rst($rst);
    }
    ...
    public function orderGet($order_id)
    {
        ...
        $rst = $this->_request->post($this->_url . 'card/giftcard/order/get', $params);
        return $this->_client->rst($rst);
    }
    ...
    public function orderBatchget($begin_time = 0, $end_time = 0, $sort_type = 'ASC', $offset = 0, $count = 100)
    {
        ...
        $rst = $this->_request->post($this->_url . 'card/giftcard/order/batchget', $params);
        return $this->_client->rst($rst);
    }
    ...
    public function generalcardUpdateuser($code, $card_id = '', $background_pic_url = '', $balance = null, $record_balance = '', $custom_field_value1 = '', $custom_field_value2 = '', $custom_field_value3 = '', $can_give_friend = null)
    {
        ...
        $rst = $this->_request->post($this->_url . 'card/generalcard/updateuser', $params);
        return $this->_client->rst($rst);
    }
    ...
    public function orderRefund($order_id)
    {
        ...
        $rst = $this->_request->post($this->_url . 'card/giftcard/order/refund', $params);
        return $this->_client->rst($rst);
    }
    ...
    public function paywhitelistAdd($sub_mch_id)
    {
        ...
        $rst = $this->_request->post($this->_url . 'card/giftcard/pay/whitelist/add', $params);
        return $this->_client->rst($rst);
    }
    ...
    public function paysubmchBind($sub_mch_id, $wxa_appid)
    {
        ...
        $rst = $this->_request->post($this->_url . 'card/giftcard/pay/submch/bind', $params);
        return $this->_client->rst($rst);
    }
    ...
    public function wxaSet($wxa_appid, $page_id)
    {
        ...
        $rst = $this->_request->post($this->_url . 'card/giftcard/wxa/set', $params);
        return $this->_client->rst($rst);
    }
}
