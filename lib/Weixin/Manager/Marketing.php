...
class Marketing
{
    ...
    public function useractionsetsAdd($type, $name, $description)
    {
        ...
        $rst = $this->_request->post($this->_url . 'marketing/user_action_sets/add?version=v1.0', $params, $headers);
    ...
    public function useractionsetsGet($user_action_set_id)
    {
        ...
        $rst = $this->_request->get($this->_url . 'marketing/user_action_sets/get?version=v1.0', $params);
        return $this->_client->rst($rst);
    }
    ...
    public function useractionsAdd($user_action_set_id, $url, $action_time, $action_type, $trace, $action_param)
    {
        ...
        $rst = $this->_request->post($this->_url . 'marketing/user_actions/add?version=v1.0', $params, $headers);
        return $this->_client->rst($rst);
    }
}
