...
class Card
{
     ...
     * check_consume否booltrue是否校验code核销状态，填入true和false时的code异常状态返回数据不同。
     * 返回数据说明
     * 数据示例：
     * {
     * "errcode":0,
     ...
     * @return mixed
     */
    public function codeGet($code, $card_id = "", $is_expire_dynamic_code = NULL, $check_consume = true)
    {
        $params = array();
        $params['code'] = $code;
        if (! empty($card_id)) {
    ...
    public function codeMark($card_id, $code, $openid, $is_mark = true)
    {
        ...
        $rst = $this->_request->post($this->_url2 . 'card/code/mark', $params);
        return $this->_client->rst($rst);
    }
    ...
    public function invoiceGetauthurl($s_appid, $order_id, $money, $timestamp, $source, $redirect_url, $ticket, $type)
    {
        ...
        $params['type'] = $type;
        $rst = $this->_request->post($this->_url . "card/invoice/getauthurl", $params);
        return $this->_client->rst($rst);
    }
    ...
    public function invoiceGetauthdata($order_id, $s_appid)
    {
        ...
        $params['order_id'] = $order_id;
        $params['s_appid'] = $s_appid;
        $rst = $this->_request->post($this->_url . "card/invoice/getauthdata", $params);
        return $this->_client->rst($rst);
    }
    ...
    public function invoiceRejectinsert($s_appid, $order_id, $reason, $url)
    {
        ...
        $params['url'] = $url;
        $rst = $this->_request->post($this->_url . "card/invoice/rejectinsert", $params);
        return $this->_client->rst($rst);
    }
    ...
    public function setAuthField4InvoiceSetbizattr(\Weixin\Model\Invoice\AuthField $auth_field)
    {
        ...
        $rst = $this->_request->post($this->_url . "card/invoice/setbizattr?action=set_auth_field", $params);
        return $this->_client->rst($rst);
    }
    ...
    public function getAuthField4InvoiceSetbizattr(\Weixin\Model\Invoice\AuthField $auth_field)
    {
        ...
        $rst = $this->_request->post($this->_url . "card/invoice/setbizattr?action=get_auth_field", $params);
        return $this->_client->rst($rst);
    }
    ...
    public function setPaymch4InvoiceSetbizattr(\Weixin\Model\Invoice\PaymchInfo $paymch_info)
    {
        ...
        $rst = $this->_request->post($this->_url . "card/invoice/setbizattr?action=set_pay_mch", $params);
        return $this->_client->rst($rst);
    }
    ...
    public function getPaymch4InvoiceSetbizattr(\Weixin\Model\Invoice\PaymchInfo $paymch_info)
    {
        ...
        $rst = $this->_request->post($this->_url . "card/invoice/setbizattr?action=get_pay_mch", $params);
        return $this->_client->rst($rst);
    }
    ...
    public function invoiceMakeoutinvoice(\Weixin\Model\Invoice\Invoiceinfo $invoiceinfo)
    {
        ...
        $rst = $this->_request->post($this->_url . "card/invoice/makeoutinvoice", $params);
        return $this->_client->rst($rst);
    }
    ...
    public function invoiceClearoutinvoice($wxopenid, $fpqqlsh, $nsrsbh, $nsrmc, $yfpdm, $yfphm)
    {
        ...
        $rst = $this->_request->post($this->_url . "card/invoice/clearoutinvoice", $params);
        return $this->_client->rst($rst);
    }
    ...
    public function invoiceQueryinvoceinfo($fpqqlsh, $nsrsbh)
    {
        ...
        // nsrsbh String 是 纳税人识别码
        $params['nsrsbh'] = $nsrsbh;
        $rst = $this->_request->post($this->_url . "card/invoice/queryinvoceinfo", $params);
        return $this->_client->rst($rst);
    }
    ...
    public function setContact4InvoiceSetbizattr(\Weixin\Model\Invoice\Contact $contact)
    {
        ...
        $rst = $this->_request->post($this->_url . "card/invoice/setbizattr?action=set_contact", $params);
        return $this->_client->rst($rst);
    }
    ...
    public function getContact4InvoiceSetbizattr(\Weixin\Model\Invoice\Contact $contact)
    {
        ...
        $rst = $this->_request->post($this->_url . "card/invoice/setbizattr?action=get_contact", $params);
        return $this->_client->rst($rst);
    }
}
