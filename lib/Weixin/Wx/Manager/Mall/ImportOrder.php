...
class ImportOrder
{
    ...
    public function add($order_list)
    {
        ...
        $rst = $this->_request->post($this->_url . 'mall/importorder?action=add-order', $params);
    ...
    public function update($order_list)
    {
        ...
        $params['order_list'] = $params_order_list;
        $rst = $this->_request->post($this->_url . 'mall/importorder?action=update-order', $params);
        return $this->_client->rst($rst);
    }
    ...
    public function delete($user_open_id, $order_id)
    {
        ...
        $rst = $this->_request->post($this->_url . 'mall/deleteorder', $params);
        return $this->_client->rst($rst);
    }
}
