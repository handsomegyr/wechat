...
class Template
{
    ...
    public function libraryList($offset = 0, $count = 20)
    {
        ...
        $params['count'] = $count;
        $rst = $this->_request->post($this->_url . 'wxopen/template/library/list', $params);
    ...
    public function libraryGet($id)
    {
        $params = array();
        $params['id'] = $id;
        $rst = $this->_request->post($this->_url . 'wxopen/template/library/get', $params);
        return $this->_client->rst($rst);
    }
    ...
    public function add($id, array $keyword_id_list)
    {
        ...
        $rst = $this->_request->post($this->_url . 'wxopen/template/add', $params);
        return $this->_client->rst($rst);
    }
    ...
    public function getlist($offset = 0, $count = 20)
    {
        ...
        $params['offset'] = $offset;
        $params['count'] = $count;
        $rst = $this->_request->post($this->_url . 'wxopen/template/list', $params);
        return $this->_client->rst($rst);
    }
    ...
    public function del($template_id)
    {
        ...
        $rst = $this->_request->post($this->_url . 'wxopen/template/del', $params);
        return $this->_client->rst($rst);
    }
    ...
    public function send($touser, $template_id, array $data, $form_id, $page = '', $color = '', $emphasis_keyword = '')
    {
        ...
        $rst = $this->_request->post($this->_url . 'message/wxopen/template/send', $params);
        return $this->_client->rst($rst);
    }
    ...
    public function uniformSend($touser, array $mp_template_msg, array $weapp_template_msg)
    {
        ...
        $rst = $this->_request->post($this->_url . 'message/wxopen/template/uniform_send', $params);
        return $this->_client->rst($rst);
    }
}
