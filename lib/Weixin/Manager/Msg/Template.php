...
class Template
{
     ...
     * }
     */
    public function subscribe($touser, $template_id, $url, $scene, $title, array $data, array $miniprogram = null)
    {
        $params = array();
        $params['touser'] = $touser;
        $params['template_id'] = $template_id;
        ...
        $rst = $this->_request->post($this->_url . 'message/template/subscribe', $params);
        return $this->_client->rst($rst);
    }
}
