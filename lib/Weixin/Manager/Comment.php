...
class Comment
{
    ...
    public function open($msg_data_id, $index = 0)
    {
        ...
        $params['index'] = $index;
        $rst = $this->_request->post($this->_url . 'comment/open', $params);
    ...
    public function close($msg_data_id, $index = 0)
    {
        ...
        $params['msg_data_id'] = $msg_data_id;
        $params['index'] = $index;
        $rst = $this->_request->post($this->_url . 'comment/close', $params);
        return $this->_client->rst($rst);
    }
    ...
    public function getlist($msg_data_id, $index = 0, $type = 0, $begin = 0, $count = 50)
    {
        ...
        $params['count'] = $count;
        $params['type'] = $type;
        $rst = $this->_request->post($this->_url . 'comment/list', $params);
        return $this->_client->rst($rst);
    }
    ...
    public function markelect($user_comment_id, $msg_data_id, $index = 0)
    {
        ...
        $rst = $this->_request->post($this->_url . 'comment/markelect', $params);
        return $this->_client->rst($rst);
    }
    ...
    public function unmarkelect($user_comment_id, $msg_data_id, $index = 0)
    {
        ...
        $params['index'] = $index;
        $params['user_comment_id'] = $user_comment_id;
        $rst = $this->_request->post($this->_url . 'comment/unmarkelect', $params);
        return $this->_client->rst($rst);
    }
    ...
    public function delete($user_comment_id, $msg_data_id, $index = 0)
    {
        ...
        $params['index'] = $index;
        $params['user_comment_id'] = $user_comment_id;
        $rst = $this->_request->post($this->_url . 'comment/delete', $params);
        return $this->_client->rst($rst);
    }
    ...
    public function replyAdd($user_comment_id, $content, $msg_data_id, $index = 0)
    {
        ...
        $rst = $this->_request->post($this->_url . 'comment/reply/add', $params);
        return $this->_client->rst($rst);
    }
    ...
    public function replyDelete($user_comment_id, $msg_data_id, $index = 0)
    {
        ...
        $params['index'] = $index;
        $params['user_comment_id'] = $user_comment_id;
        $rst = $this->_request->post($this->_url . 'comment/reply/delete', $params);
        return $this->_client->rst($rst);
    }
}
