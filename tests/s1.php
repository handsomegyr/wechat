...
function doGetAccessTokenTest($appid, $secret)
{
...
function doJssdkTest($appid, $secret, $access_token)
{
...
function doShortUrlTest($client)
{
...
function doSemanticTest($client)
{
...
function doDatacubeTest($client)
{
...
function doMaterialTest($client)
{
    // echo "<br/>获取素材总数接口<br/>";
